  ...
  angular.module("Blue").directive("resultTrackedTable", resultTrackedTable);

  resultTrackedTable.$inject = [];

  function resultTrackedTable() {
    return {
      restrict: "A",
      priority: -1,
      require: "ngForm",
      controller: resultTrackedTableController
    };
  }
  ...
  function resultTrackedTableController($scope, $parse, $attrs, $element) {
    ...
    function init() {
      var setter = $parse($attrs.resultTrackedTable).assign;
      setter($scope, self);
